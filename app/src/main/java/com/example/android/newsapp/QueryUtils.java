...
public final class QueryUtils {
    ...
    public static ArrayList<Article> fetchArticleData(String requestUrl) {
        ...
        ArrayList<Article> articles = extractDataFromJson(jsonResponse);
     ...
     */
    private static ArrayList<Article> extractDataFromJson(String articlesJSON) {
        ...
        try {
            ...
            // For each article in the results array, create an {@link Article} object
